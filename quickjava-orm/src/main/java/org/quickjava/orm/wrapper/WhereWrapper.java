 ...
 * 基础条件定义
 */
public interface WhereWrapper<Children, M, Func extends MFunction<M, ?>> extends Chain<Children> {
    ...
    default Children where(Logic logic, boolean condition, String table, String column, Operator operator, Object value) {
        if (condition) {
            if (logic == Logic.AND) {
    ...
    default Children where(boolean condition, String table, String column, Operator operator, Object val) {
        return this.where(getLogic(), condition, table, column, operator, val);
    }

    default Children where(boolean condition, String table, String column, Object val) {
        return this.where(getLogic(), condition, table, column, Operator.EQ, val);
    }
