...
public class ORMMyBatisLoader implements InitializingBean, ORMContextPort {

    private static final Logger logger = LoggerFactory.getLogger(ORMMyBatisLoader.class);

    private static ApplicationContext applicationContext;

    private static ORMMyBatisLoader instance;
    ...
    public ORMMyBatisLoader(ApplicationContext applicationContext) {
